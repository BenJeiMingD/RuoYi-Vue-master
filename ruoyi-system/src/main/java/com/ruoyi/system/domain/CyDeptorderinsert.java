...
/**
 * 填报派单插单对象 cy_deptorderinsert
 *
 * @author ruoyi
 * @date 2022-11-17
 */
public class CyDeptorderinsert extends BaseEntity
{
    ...
    /** 组的总产能（废弃） */
    @Excel(name = "组的总产能", readConverterExp = "废=弃")
    ...
    public void setCyFromId(Integer cyFromId)
    {
        this.cyFromId = cyFromId;
    }

    public Integer getCyFromId()
    {
        return cyFromId;
    }
